module github.com/fortxun/caza-otel-ai-processor
...
// Fix the wasmer-go compatibility issue
replace github.com/wasmerio/wasmer-go => github.com/wasmerio/wasmer-go v1.0.4
